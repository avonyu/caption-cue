...
const FULLSCREEN_SELECTOR = ".xgplayer-fullscreen"
...
const DouyinJingxuanMenu = () => {
  ...
  return (
    <div ref={menuRef} className="relative inline-flex align-middle">
      <button
        type="button"
        title="打开幕听菜单"
        aria-label="打开幕听菜单"
        ...
        className="caption-cue-douyin-menu relative m-0 box-border inline-flex h-10 w-10 cursor-pointer items-center justify-center border-0 bg-transparent p-0 align-middle hover:opacity-[0.86]">
        <img
...
export default DouyinJingxuanMenu
